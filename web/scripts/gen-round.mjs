...
const roundTarget = join(root, "src/lib/game/roundSetup.ts");
const chartTarget = join(root, "src/lib/game/chartOverlays.ts");

const roundContent = `// Per-round random instrument, timeframe and indicator setup.
